...
X=A[,-L[2]]
p=dim(X)[2]	
PARA=matrix(c(0.001,0.001,0.01,0.001,0.01,0.01,0.01,2,1,2,2,1,2,1,0.7,0.7,0.7,0.5,0.7,0.5,0.5,
0.5,0.5,0.5,0.5,0.5,0.5,0.5),7)
for(kk in 1:dim(PARA)[1])
{
	eta=PARA[kk,1]
	W=PARA[kk,2]
	C=PARA[kk,3]
...
X=A[,-L[2]]
p=dim(X)[2]	
PARA=matrix(c(0.01,0.01,0.001,0.01,0.01,0.01,0.01,0.01,
1,1,1,1,2,2,2,1,0.5,0.7,0.7,0.7,0.7,0.5,0.7,0.5,
0.5,0.5,0.5,0.7,0.5,0.5,0.7,0.7),8)
for(kk in 1:dim(PARA)[1])
{
	eta=PARA[kk,1]
	W=PARA[kk,2]
